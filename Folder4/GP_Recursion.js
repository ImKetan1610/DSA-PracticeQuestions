...
Output:
Output till 4 places after the decimal. 
For instance, 12.1345 is a valid answer but 12.43138 is not. 12.0000 is also a valid answer
...
function solve(r, n) {
  if (n == 0) {
    return 1;
  } else return 1 / Math.pow(r, n) + solve(r, n - 1);
}
...
function runProgram(input) {
  ...
  let n = input[0];
  let r = input[1];
  console.log(solve(r, n).toFixed(4));
}
