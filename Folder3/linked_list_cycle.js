...
just return if the given linked list has a cycle in it or not.
...
Next line contains the position of the node that the tail of the linked list points to. 
(If it's -1 then it doesn't point to anything)
t <= 10
n <= 10
