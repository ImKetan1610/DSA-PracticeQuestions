...
Problem Statement:
You love food. 
Hence, you took up position of a manager at Masai restaurant that serves people with delicious food packages. 
...
The job of a manager is very difficult. You need to handle two types of queries:
...
And reports the cost of the package to the Manager.
...
Output:
For each Type-1 Query, output the price that customer has to pay 
i.e. cost of the package given to the customer in a new line. 
