...
Say for example , tad#bc### results in t as the first # deleted d leaving tabc### 
...
Output for each question CORRECT or WRONG if both the answer 
    and solution after deleting respective elements come out to be same or different.
