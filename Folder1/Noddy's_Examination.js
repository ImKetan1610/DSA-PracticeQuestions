...
Now, Noddy can only solve the problems that have difficulty level less than or equal toX. Now the rules are:
The score of Noddy is equal to the maximum number of answers he has attempted without skipping a question.
Noddy is allowed to skip just "one" question that will not be counted in the continuity of the questions.
Note: Assume Noddy knows the solution to the problem he attempts and always starts the paper from the first question (index 0).
Given the number of Questions, N, 
the maximum difficulty level of the problem Noddy can solve, X, and the difficulty level of each question in the form of an Array, A
